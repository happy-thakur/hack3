...
dishRouter.route('/')
    ...
    .post(cors.corsWithOptions, authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => {
        MainProds.find({ "cat": req.body.cat, "tlc_s": req.body.tlc_s, "p_desc": req.body.p_desc, "p_brand": req.body.p_brand, "pc_n": req.body.pc_n, "tlc_n": req.body.tlc_n })
            .then((shop) => {
                console.log(shop);
